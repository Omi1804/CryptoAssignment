...
const TopCreatorSec = () => {
  return (
    <div className="py-[4rem] px-[9rem] my-4 border-t border-[rgba(255,255,255,.15)] flex justify-center items-center flex-col">
      ...
      <div className="w-full grid grid-cols-4 justify-items-center content-center gap-4 mt-8">
        <div
        ...
        >
          ...
          <p className="absolute bottom-0 w-full z-50 text-[#ffffffaf] text-xl font-medium py-2 px-4 tracking-wide">
